...
//=====================================================================================================================================================================
    ...
    if(!videoSource.open(argv[2])){
        std::cout<< "Can't load video" << std::endl;
        return 1;
    } 
    int countFrame = 0;
    while(true){
        ...
        int timeInfer = std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count();
        float fps = 1 / (timeInfer*0.001);
        std::cout << "Frame: " << countFrame << " " << fps << "fps" << std::endl;
